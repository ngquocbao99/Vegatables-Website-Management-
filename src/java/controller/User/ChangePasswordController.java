...
public class ChangePasswordController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String oldPass = request.getParameter("oldPass");//mật khẩu người dùng nhập vào
        String pass = request.getParameter("pass");//mật khẩu mới
        String repass = request.getParameter("repass");//nhập lại mật khẩu mới
        ...
        if (currentPass.equals(checkPass)) {
            ...
            if (pass.equals(repass)) {
                ...
                request.setAttribute("mess", "Mật khẩu nhập lại phải giống!");
